...
class StatsController < ApplicationController
  ...
  def meta
    ...
    render partial: 'stats/meta', locals: { meta:, stats: }
  end
  ...
  def stats_usuario; end


  private

  def gerente_stats(datos, id); end

  def lider_stats(datos, id); end

  def revisor_stats(datos, id); end

  def integrante_stats(datos, id); end
